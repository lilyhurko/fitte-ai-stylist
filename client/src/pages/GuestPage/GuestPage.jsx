    ...
    <div className="guest-container">
      ...
      <main className="hero-section">
        ...
        <p className="hero-subtitle">
          Fitte analizuje Twoje ubrania i dobiera idealne stylizacje przy użyciu
          zaawansowanych modeli językowych. Oszczędź czas i zawsze wyglądaj
          świetnie.
        </p>
      ...
      <section className="features-grid">
        <div className="feature-card">
          ...
          <p>
            Nasz system zna każdy element Twojej garderoby i proponuje tylko to,
            co naprawdę masz w szafie.
          </p>
        </div>
        <div className="feature-card">
          <h3>Analiza Porównawcza</h3>
          <p>
            Wykorzystujemy moc GPT-4, Gemini i Mistral, aby dostarczyć Ci
        ...
        <div className="feature-card">
          ...
          <p>
            Zdefiniuj swój styl poprzez nasz inteligentny kalkulator i ciesz się
            modą na nowo.
          </p>
        </div>
      </section>
